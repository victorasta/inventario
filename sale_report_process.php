...
<html lang="en-US">
 <head>
   ...
   <title>Factura Sistema de Inventario</title>
...
<body onload='window.print();'>
  <?php if($results): ?>
        ...
        <tbody>
          <?php foreach($results as $result): ?>
           <tr>
              ...
              <td class="text-right"><?php $hora= date ("h:i:s"); echo $hora;?></td>
    ...
    <form>
<input type='hidden'  value='Imprimir' /></form>
  <?php
    else:
